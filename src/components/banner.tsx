...
export default function Banner() {
    ...
    return (
      <div className="w-full h-screen flex justify-center items-center">
        <div className="text-center space-y-6">
          <Image
            src="/logo.png"
            alt="Saud Solutions Loading Logo"
            width={120}
            height={80}
  ...
  return (
    <section className="relative w-full overflow-hidden" aria-label="Promotional Banner Carousel">
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "ImageGallery",
          "name": "Saud Solutions Promotional Banners",
          "description": "Explore the latest deals and promotions at Saud Solutions.",
          "image": banners.map((banner) => ({
            "@type": "ImageObject",
            "url": urlFor(banner.image).url(),
            "caption": banner.alt || `Saud Solutions Banner ${banner.centerHeading || ''}`,
          })),
        })}
      </script>
          ...
          if (index === currentSlide) {
            return (
              ...
              >
                ...
                <Image
                  src={urlFor(banner.image).width(1200).height(600).format('webp').url()}
                  alt={banner.alt || `Saud Solutions ${banner.centerHeading || 'Promotion'} Banner`}
                  width={1200}
                  height={600}
                  priority={index === 0}
                ...
                {banner.buttonLink && (
                  <Link
                    ...
                    aria-label={`Explore ${banner.centerHeading || 'Promotion'}`}
