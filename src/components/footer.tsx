            ...
            <div className="container mx-auto px-4">
                <div className="md:flex justify-between mx-10 md:mx-0 lg:mx-28">
                    ...
                    <div className="w-full md:w-1/4 mb-6 md:mb-0">
                        ...
                        <ul className="md:mt-12 mt-3 font-semibold space-y-2">
                            <li>
                                <Link
                                    href="/"
                    ...
                    <div className="w-full md:w-1/4">
                        ...
                        <form onSubmit={handleSubmit} className="md:flex mt-12 gap-2">
                            ...
                            <button
                                type="submit"
                                className="border-b-2 border-gray-700 text-gray-950 font-bold text-sm"
                ...
                <div className="mt-8 text-start font-medium border-t-2 mx-5 md:mx-24 py-6 text-gray-950 text-sm">
                    © {new Date().getFullYear()} Saud Solution. All rights reserved.
                </div>
            </div>
        </footer>
    );
