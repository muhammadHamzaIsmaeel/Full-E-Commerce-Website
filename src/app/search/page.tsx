...
import ProductGrid from '@/components/shop/products'; // Adjust path if needed
import { IProduct } from '@/types'; // Adjust path if needed
import { FaSearch } from 'react-icons/fa';  // Import search icon
import { BeatLoader } from 'react-spinners'; // Import a spinner for loading
...
async function getSearchProducts(query: string) {
    try {
        ...
        return []; // Return an empty array in case of error to prevent crashes
    }
}
