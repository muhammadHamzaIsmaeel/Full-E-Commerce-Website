...
export default function BeautyPage() {
    ...
    const fetchProducts = async () => {
      try {
        const products: IProduct[] = await client.fetch(
          '*[_type == "product" && "home" in category]{_id, title, shortDescription, dicountPercentage, price, oldPrice, isNew, productImage, freeDelivery, tags}'
        );
        setData(products);
  ...
  return (
    <>
      ...
      <Head>
        <title>Home product - Saud Solution</title>
        <meta
          name="description"
          content="Discover our exclusive collection of Home products."
        />
        <meta
          name="keywords"
          content="Home products, Home appliances, Home decor, Home essentials"
        />
      ...
      <div>
        ...
        <div className="relative w-full h-[50vh]">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-gray-950">
            ...
            <h4 className="text-4xl font-bold">Home Products</h4>
